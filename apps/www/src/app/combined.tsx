...
// Data for the sections (updated to match services page)
const services = [
  {
    icon: <FaBroadcastTower className="text-white text-2xl" />,
    title: "Live Event Streaming",
    description: "Professional live streaming of cultural events, festivals, and ceremonies with multi-camera setup.",
    link: "/services/live-broadcasting",
  },
  {
    icon: <FaPhotoVideo className="text-white text-2xl" />,
    title: "Photography Services",
    description: "High-quality photography for events, portraits, and commercial use with professional editing.",
    link: "/services/photography",
  },
  {
    icon: <GiBigDiamondRing className="text-white text-2xl" />,
    title: "Wedding Services",
    description: "Comprehensive wedding videography and photography to capture your special day beautifully.",
    link: "/services/wedding",
  },
  {
    icon: <TbCoffin className="text-white text-2xl" />,
    title: "Funeral Services",
    description: "Respectful funeral coverage and memorial videos to honor your loved ones with dignity.",
    link: "/services/funeral",
  },
  {
    icon: <GiDeliveryDrone className="text-white text-2xl" />,
    title: "Drone Services",
    description: "Aerial videography and photography using state-of-the-art drone technology for cinematic shots.",
    link: "/services/drone-videography",
  },
  {
    icon: <FaFilm className="text-white text-2xl" />,
    title: "Documentary Production",
    description: "Authentic storytelling that captures the essence of Volta and Oti cultures with professional filming.",
