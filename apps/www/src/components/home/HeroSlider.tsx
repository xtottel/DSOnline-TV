...
const HeroSlider = () => {
  ...
  },
  {
    ...
    image: "https://cdn.sendexa.co/images/carousel/61436.jpg",
    stats: [
      {
  ...
  {
    title: "Email That Hits the Inbox — Not Spam",
    description:
      "Send transactional and marketing emails with high deliverability, speed, and engagement analytics for every message.",
    image: "https://cdn.sendexa.co/images/carousel/email.jpg",
    stats: [
      {
        icon: <MailCheck className="h-5 w-5 text-emerald-400" />,
        text: "99.7% Inbox Delivery Rate",
      },
      {
        icon: <BarChart3 className="h-5 w-5 text-emerald-400" />,
        text: "Advanced Open, Click & Bounce Metrics",
      },
    ],
    ctaPrimary: "Use Email API",
    ctaPrimaryLink: "https://app.sendexa.co/",
    ctaSecondary: "Explore Features",
    ctaSecondaryLink: "/products/email",
    accentColor: "from-emerald-600/20 via-emerald-700/30 to-emerald-800/40",
  },
  {
    title: "Crystal-Clear Voice for Global Conversations",
    description:
      "Run voice campaigns, IVR flows, and click-to-call features with low latency and global coverage.",
    image: "https://cdn.sendexa.co/images/carousel/voice.jpg",
    stats: [
      {
        icon: <PhoneCall className="h-5 w-5 text-rose-400" />,
        text: "HD Voice Quality Across Regions",
      },
      {
        icon: <Mic className="h-5 w-5 text-rose-400" />,
        text: "Programmable IVR & Call Recording",
      },
    ],
    ctaPrimary: "Try Voice API",
    ctaPrimaryLink: "https://app.sendexa.co/",
    ctaSecondary: "How It Works",
    ctaSecondaryLink: "/products/voice",
    accentColor: "from-rose-600/20 via-rose-700/30 to-rose-800/40",
  },
  {
    title: "USSD Menus with Instant Access Anywhere",
    description:
      "Deploy interactive USSD apps for payments, surveys, service activation, and real-time customer support.",
    image: "https://cdn.sendexa.co/images/carousel/ussd.jpg",
    stats: [
      {
        icon: <Terminal className="h-5 w-5 text-blue-400" />,
        text: "Zero Internet Required — 100% Reach",
      },
      {
        icon: <LayoutPanelLeft className="h-5 w-5 text-blue-400" />,
        text: "Flexible Menus & Seamless Navigation",
      },
    ],
    ctaPrimary: "Launch USSD Service",
    ctaPrimaryLink: "https://app.sendexa.co/",
    ctaSecondary: "See USSD Use Cases",
    ctaSecondaryLink: "/products/ussd",
    accentColor: "from-blue-600/20 via-blue-700/30 to-blue-800/40",
  },
  {
    title: "Unified Chat API for WhatsApp, Messenger & More",
    description:
      "Power real-time conversations across WhatsApp, Facebook, and more — with message tracking and unified inbox.",
    image: "https://cdn.sendexa.co/images/carousel/chat.jpg",
    stats: [
      {
        icon: <MessageCircle className="h-5 w-5 text-purple-400" />,
        text: "Multi-Platform Chat in One API",
      },
      {
        icon: <Users className="h-5 w-5 text-purple-400" />,
        text: "Real-Time Conversations + Bot Support",
      },
    ],
    ctaPrimary: "Explore Chat API",
    ctaPrimaryLink: "https://app.sendexa.co/",
    ctaSecondary: "View Integration Options",
    ctaSecondaryLink: "/products/chat",
      ...
      >
        {platformSlides.map((slide, index) => (
          <SwiperSlide key={index}>
            <div className="relative h-[75vh] min-h-[400px] md:h-[65vh] md:min-h-[600px]">
              <Image
                src={slide.image}
                alt={slide.title}
                fill
                  ...
                  >
                    ...
                    >
                      <Link
                        ...
                        className="group relative inline-flex items-center justify-center px-6 py-3 rounded-lg bg-gradient-to-r from-blue-800 to-blue-900 hover:to-primary-700 transition-all duration-300 text-white text-base font-semibold overflow-hidden sm:px-8 sm:py-4 sm:rounded-xl sm:text-lg"
                      >
